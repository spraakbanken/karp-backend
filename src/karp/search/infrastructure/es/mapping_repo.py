...
class EsMappingRepository:
    ...
    def is_nested(self, resource_ids: tuple[str], field):
        """
    ...
    @methodtools.lru_cache(maxsize=None)
    def get_non_nested_children(self, resources: tuple[str, ...], field_path) -> Iterable[str]:
        """
    ...
    @methodtools.lru_cache(maxsize=None)
    def get_field(self, resource_ids: tuple[str, ...], field_name):
        if field_name == "@id":
    ...
    def _update_field_mapping(self, aliases: list[tuple[str, str]]):
        ...
        mapping: dict[str, dict[str, dict[str, dict[str, dict]]]] = es.indices.get_mapping().body
    ...
    @methodtools.lru_cache(maxsize=None)
    def get_fields_as_tree(self, resource_ids: tuple[str, ...], path: tuple[str, ...]) -> dict[str, Any]:
        """
    ...
    @methodtools.lru_cache(maxsize=None)
    def get_default_sort(self, resources: tuple[str]) -> list[str] | None:
        """
    ...
    def translate_sort_fields(
        self, resources: tuple[str], sort_values: tuple[str]
