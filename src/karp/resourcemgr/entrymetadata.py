...
class EntryMetadata:
    ...
    def __init__(self, user_id: str, version: int=1, last_modified: Optional[int]=None):
        self.version = version
        self.last_modified = datetime.now(timezone.utc).timestamp() if not last_modified else last_modified
