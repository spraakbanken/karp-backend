...
class GenericSearchQuery(SearchQuery):  # noqa: D101
    ...
    def check_resource_published(self, resource_id: str):  # noqa: ANN201, D102
    ...
    def check_all_resources_published(self, resource_ids: typing.Iterable[str]):  # noqa: ANN201, D102
        with self.resource_uow:
    ...
    def query(self, req: search_service.QueryRequest):  # noqa: ANN201, D102
    ...
    def query_split(self, req: search_service.QueryRequest):  # noqa: ANN201, D102
        self.check_all_resources_published(req.resource_ids)
        with self.search_service_uow as uw:
            return uw.repo.query_split(req)

    def statistics(self, resource_id: str, field: str):  # noqa: ANN201, D102
        self.check_resource_published(resource_id)
        with self.search_service_uow as uw:
