...
def fixture_entry_repo(sqlite_session_factory):  # noqa: ANN201, ANN001
...
def fixture_entry_repo2(sqlite_session_factory):  # noqa: ANN201, ANN001
    session = sqlite_session_factory()
    entry_repo = SqlEntryRepository.from_dict(
        name="test_name2",
        resource_config={},
...
def test_create_entry_repository(entry_repo):  # noqa: ANN201, ANN001
    assert entry_repo.entity_ids() == []


def test_save_entry_to_entry_repo(entry_repo):  # noqa: ANN201, ANN001
...
def test_update_entry_to_entry_repo(entry_repo):  # noqa: ANN201, ANN001
    entry = factories.EntryFactory()
    entry_repo.save(entry)
...
def test_discard_entry_and_insert_new(entry_repo):  # noqa: ANN201, ANN001
...
def test_create_entry_repository2(entry_repo2):  # noqa: ANN201, ANN001
    assert entry_repo2.entity_ids() == []


class TestSqlEntryRepoGetHistory:
    def test_discard_entry_and_insert_new(self, entry_repo):  # noqa: ANN201, ANN001
        pass
