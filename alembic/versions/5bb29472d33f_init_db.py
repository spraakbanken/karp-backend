...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('entry_id', 'version', name='entry_id_version_unique_constraint')
    )
    op.create_table('resource_definition',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('resource_id', 'version', name='resource_version_unique_constraint')
    )
